    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/izzulroslan"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/izzulroslan/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/izzulroslan/"><i className="ri-linkedin-box-fill ri-2x"></i></a>
        </div>
